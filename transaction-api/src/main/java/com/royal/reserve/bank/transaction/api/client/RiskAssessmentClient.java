...
public interface RiskAssessmentClient {
    ...
    /**
     *
     *Requests a risk assessment for a transaction from the Risk Assessment API.
     *@param request The transaction data (id, items and values) to assess.
     *@return A RiskAssessmentResponse containing the risk level and whether the transaction is approved.
     */
